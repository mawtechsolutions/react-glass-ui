...
const variantIcons: Record<ToastVariant, React.ReactNode> = {
  default: (
    <svg className="w-5 h-5 text-glass-cyan" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const ToastProvider: React.FC<ToastProviderProps> = ({
  ...
  return (
    <ToastContext.Provider value={{ toasts, addToast, removeToast, clearToasts }}>
      ...
      {/* Toast Container */}
      <div
        className={cn('fixed z-[9999] flex flex-col gap-2', positionClasses[position])}
